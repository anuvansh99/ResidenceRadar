    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (+formData.regularPrice < +formData.discountPrice)
                return setError("Discount price must be smaler than regular price");
            setLoading(true);
            setError(false);
            const res = await fetch(`/api/listing/update/${params.listingId}`, {
                ...
                credentials: 'include', // <-- Added for authenticated update
                body: JSON.stringify({
                    ...formData,
            ...
            <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <div className='flex gap-4'>
                        ...
                        bg-green-700 text-white border border-slate-700 rounded uppercase hover:shadow-lg disabled:opacity-80' >
